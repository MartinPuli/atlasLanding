  ...
  return (
    <Section id="about" spacing="xl">
      <Container size="lg">
        ...
        {/* Intro Story */}
        <div className="max-w-4xl mx-auto mb-20 sm:mb-28 lg:mb-36">
        ...
        {/* Vision & Mission */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 mb-20 sm:mb-28 lg:mb-36">
          {/* Vision */}
          <GlassCard padding="xl" className="group relative overflow-hidden">
            ...
            <div className="flex flex-col h-full">
              <div className="mb-6">
                <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br from-cyan-400/20 to-blue-500/20 flex items-center justify-center icon-glow">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-[#8BA3B8] leading-relaxed flex-grow">
                {t.vision.desc}
              </p>
            </div>
          </GlassCard>
          ...
          <GlassCard padding="xl" className="group relative overflow-hidden">
            ...
            <div className="flex flex-col h-full">
              <div className="mb-6">
                <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center icon-glow">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-7 h-7 sm:w-8 sm:h-8 text-cyan-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 mb-16 sm:mb-20">
          {t.values.map((value, index) => (
            <GlassCard key={index} padding="lg" className="group text-center">
              <div className="flex flex-col items-center gap-5 sm:gap-6">
                ...
                {/* Description */}
                <p className="text-sm sm:text-base lg:text-lg text-[#8BA3B8] leading-relaxed">
                  {value.desc}
                </p>
              </div>
            </GlassCard>
